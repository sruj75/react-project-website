...
function About() {
  return (
    <div className='w-full bg-black text-red-600 py-20 pl-20 pr-20 font-["Times_New_Roman"] text-4xl'>
       <h1> In hell, your suffering wil be your only company.</h1>
        <h1> Flames will lick at your flesh, comsuming you with relentless fury.</h1>
